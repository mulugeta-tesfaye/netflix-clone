    ...
    <div className='login'>
      ...
      <div className="login-form">
        ...
        <div className="form-switch">
          {signState === "Sign In"? <p>New to Netflex? <span onClick={()=>setSignState("Sign Up")}>Sign Up Now</span></p>:<p>Already have an account? <span onClick={()=>setSignState("Sign In")} >Sign In Now</span></p>}
